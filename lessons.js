...
function start(less) {
    ...
    switch (less) {
        ...
        case 2:
            ...
            break;
        case 3:
            inp = "<!-- Below is an opening header tag -->\n<h1>\n\n</h1>\n<!-- Above is an closing header tag -->\n\n<!-- The slash makes it a closing tag. Anything inside will be a header (exept the comment). Try typing something between the tags. -->";
            addlines(8);
            break;
        case 4:
            inp = "<h1>You can replace</h1>\n<h2>The 'h1'</h2>\n<h3>With any tag you want!</h3>\n<!-- I will teach you about some of them later. -->";
            break;
        case 5:
        ...
        case 6:
            ...
            break;
        case 7:
            inp = "<!-- I am only covering the bare mininum of tags. You can find more conplicated tags at w3schools.com -->";
            break;
        case 8:
            inp = "<!-- Now I will show you attributes. the format for attributes is\" attribute='value' \" -->\n\n<a>This is a link</a>\n\n<!-- It only looks like text right now. You need to add an 'href' attribute. The value for the 'href' attribute will be the link you want to go to. -->\n\n<br>\n\n<a href='https://google.com'>Click Me!</a>\n\n<!-- Normally links will open in the sabe tab you click them on, but this website is set to open them in a new tab so you don't loose your progress. The 'br' tag adds a space between the two links. 'br' tags dont need a closing tag. -->";
            break;
        case 9:
            inp = "<!-- Nect up are buttons. The following button will open a dialog box that says 'hi' -->\n\n<button onclick=\"alert('hi');\">Click Me</button>\n\n<!-- Lets break that down. The 'onclick' attribute runs code when the tag it is on is pressed (like the button).\n\nThe value of the onclick is \"alert('hi')\".\n\n'alert' opens text in a dialog box.\n\nThe text it opens is what comes after in in parentheses. 'alert()'\n\nBecause we want to alert plain text, we put our text in quotes. \"alert('')\".\n\nThe reason that is so complex is because \"alert('')\" is JavaScript, and that is another language. Sorry for being so complex.\n\n-->";
            addlines(18);
            break;
        case 10:
